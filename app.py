...
MONGODB_CONNECTION_STRING = "mongodb+srv://test:sparta@cluster0.bxgxpsu.mongodb.net/?retryWrites=true&w=majority"
...
def get_posts():
    ...
    try:
        ...
        for post in posts:
            ...
            post["count_star"] = db.star.count_documents({"post_id": post["_id"], "type": "star"})
            post["count_thumbsup"] = db.thumbsup.count_documents({"post_id": post["_id"], "type": "thumbsup"})
            ...
            post["thumbsup_by_me"] = bool(db.likes.find_one({"post_id": post["_id"], "type": "thumbusup", "username": payload.get('id')}))
